...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-multi-date', __webpack_require__(3));
  Vue.component('detail-nova-multi-date', __webpack_require__(6));
  Vue.component('form-nova-multi-date', __webpack_require__(9));
});
